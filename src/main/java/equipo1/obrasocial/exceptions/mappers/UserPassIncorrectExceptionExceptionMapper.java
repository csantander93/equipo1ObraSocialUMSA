...
@Provider
public class UserPassIncorrectExceptionExceptionMapper implements ExceptionMapper<UserPassIncorrectException> {

    @Override
    public Response toResponse(UserPassIncorrectException exception) {
